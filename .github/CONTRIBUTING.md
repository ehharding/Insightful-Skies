# Welcome to the Insightful Skies Contributing Guide
...
[issue form](https://github.com/ehharding/Insightful-Skies/issues/new/choose).

#### Solve an Issue

Scan through our [existing issues](https://github.com/ehharding/Insightful-Skies/issues) to find one that interests you.
You can narrow down the search using `labels` as filters. As a general rule, we don’t assign issues to anyone. If you
...
Congratulations :tada::tada: The Insightful Skies team thanks you :sparkles:.
